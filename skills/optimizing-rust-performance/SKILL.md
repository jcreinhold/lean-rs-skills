...
Use this skill for measurement-driven Rust performance work. The default job is not "make it faster." The job is: pick a
real workload, measure a baseline, localize the bottleneck, choose the right intervention level, change code, and
re-measure.
