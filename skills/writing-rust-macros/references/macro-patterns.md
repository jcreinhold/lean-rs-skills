...
Use `$crate::` in exported declarative macros. Accept `$vis:vis` and relevant attributes for generated items. Avoid evaluating a captured expression more than once.
