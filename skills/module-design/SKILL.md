...
Read `references/rust-patterns.md` or `references/lean4-patterns.md` for language patterns. Use `proof-design` for theorem statements and proof structure.
...
If unclear, run `bash skills/module-design/scripts/audit-module.sh <path>` from the plugin root.
...
- [ ] Run `bash skills/module-design/scripts/audit-module.sh <path>`.
...
- `rust-testing` for tests coupled to internals.
- `proof-design` for theorem statements and lemma design.
